...
public class User 
{
  ...
  {
    if(other instanceof User && other !=null){//checks invalid conditions
      User o = (User) other;//casting
      return (this.address.equals(o.getAddress())&&this.name.equals(o.getName()));//returns corresponding boolean
    }
    return false;
  }
}
